...
//     console.log(eventID);
//     // try {
//     //   await axios.delete(`${BASEURL}/api/auth/holiday-event/eventID`)
...
export default function Holidays() {
  ...
  const handleDelete = async (id) => {
    try {
      ...
      // Update the eventData state by removing the deleted item
      // setEventData((prevData) => prevData.filter((item) => item.id !== id));
      let newData = eventData.filter((e) => {
        e._id == id;
      });
