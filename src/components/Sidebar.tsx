...
import {faCalendarWeek, faSquareParking, faBullseye, faBarsProgress, faMicrochip, faSheetPlastic, faComments, faCircleUser ,faAddressBook}  from '@fortawesome/free-solid-svg-icons';
          ...
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              <li>
                ...
                >
               <FontAwesomeIcon icon={faAddressBook} style={{color: "#ffffff",}} />
                 Add Contact
                </NavLink>
              </li>
