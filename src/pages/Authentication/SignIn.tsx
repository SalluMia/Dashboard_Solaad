...
//               <h4 className="text-1xl mb-9 font-bold text-black dark:text-white sm:text-title-xl">
//                 Sign In
//               </h4>
...
//                       className="w-full rounded-lg border border-stroke bg-transparent py-4 pl-6 pr-10 text-sm font-medium outline-none focus:border-primary focus-visible:shadow-none dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary"
//                     />
          ...
          <div className="w-full border-stroke dark:border-strokedark xl:w-1/2 xl:border-l-2">
            <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
              ...
              <form onSubmit={handleSubmit}>
                ...
                <button
                  type="submit"
                  className="hover:bg-primary-dark w-full rounded-lg bg-primary py-4 font-medium text-white transition-colors duration-300"
                >
                  Sign In
                </button>
              </form>
